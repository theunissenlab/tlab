function MetfilesScript_JEE(UT,OW)
...
for ss=1:length(Subjects)
    ...
    if length(Indiv)==11
        ...
        matfiles=dir(fullfile(Outdir,'ZS*.mat'));
        LM=length(matfiles);
        ...
        for hh=1:LH
            ...
            FE=0;
            for mm = 1:LM
                if strcmp(h5name(1:(end-3)), matfiles(mm).name(4:(end-4)));
            ...
            if FE==0
                ...
                Matfile_construct_JEE(h5file,OldWav);
                fprintf('done\n');
            end
