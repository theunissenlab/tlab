function VocSectioningAmpAdd(Folder, pl)
%% This function cut sound extract to isolate syllables in vocalizations based on the enveloppe of the syllable. 
% The function was copied from VocSectioningAmp to add files that were used in ephys but were then excluded from the FullVocalizationBank
% because of quality reason
...
if nargin<1
    ...
    if ismac()
        ...
        if strcmp(strtok(username), 'frederictheunissen')
            ...
            DataBasePath = '/Users/frederictheunissen/Google Drive File Stream/My Drive/Data/Julie/FullVocalizationBank/NeuroFiles';
...
powerFile = fullfile(DataBasePath, 'ampcheck2020Add.txt');
...
for isound = 1:nfiles
    ...
    fid = fopen('/Users/frederictheunissen/Google Drive File Stream/My Drive/Data/Julie/FullVocalizationBank/Birds_List_Acoustic.txt', 'r');
...
save('/Users/frederictheunissen/Google Drive File Stream/My Drive/Data/Julie/FullVocalizationBank/vocCuts2020Add.mat', 'ncutsTot', 'to', 'fo', 'ncutsTot', 'soundCutsAll', 'spectroCutsAll', 'soundNameCuts', 'indCutsAll', 'birdNameCuts', 'vocTypeCuts', 'samprate', '-V7.3');
