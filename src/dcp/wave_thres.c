...
int ind;
   ...
   stim_points = (stim_dur*pin->adfreq)/1000;
	...
	printf("\tMax = %f T_max = %f P_max = %g\n", stim_max, (max_t-stim_points)*1000.0/(pin->adfreq), pmax) ;
	printf("\tMin = %f T_min = %f P_min = %g\n", stim_min, (min_t-stim_points)*1000.0/(pin->adfreq), pmin) ;
	printf("\tPmax&Pmin=%g\n", pmax*pmin);
