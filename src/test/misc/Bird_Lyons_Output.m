function [out,lenout] = Bird_Lyons_Output(data,agcf)
...
earQ = 4; % Quality factor of each filter
stepfactor = .5; % 1/stepfactor is approximately the number of filters per bandwidth of one filter
