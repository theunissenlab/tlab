function [filter_fit,params] = fit_strf(strf, initialFreq, endFreq, NBAND, samprate, do_plot,verbose)
...
f_range = endFreq - initialFreq;
f_band = f_range/(NBAND - 1);
f = (0:NBAND-1) * f_band + initialFreq;
...
filter_fit.f_X0 = (initialFreq + filter_fit.f_X0 * f_band)/1000.0;
