...
int main(int argc,char ** argv)
{
	...
	double a1=atof(argv[6]);
	double a2=atof(argv[7]);
	double a3=atof(argv[8]);
	...
	double guess[]={alpha,f1,f2,f3,a1,a2,a3};
	...
	for(frame=frameCount/2;frame<frameCount;frame+=1)
	{


		double d = fitOneFramev2(&fit_data,frame,slope,intercept,best);
		printf("%d %lg ",frame,d);
		for(i=0;i<m;i++)
