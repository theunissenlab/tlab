...
in_dir='/auto/k6/hsoula/calls/solveig_data/wavs/';
out_dir='/auto/k6/hsoula/calls/new_output';
...
for i=1:n;
  ...
  params={};
  params.out=['/auto/k6/hsoula/calls/solveig_data/',name,'.txt'];
  params.memory=10000;
  params.err='/auto/k6/hsoula/calls/solveig_data/err.file';
  params.cpus=2;
