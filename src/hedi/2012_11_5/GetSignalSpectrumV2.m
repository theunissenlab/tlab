function [final_signal,final_spectrum,raw_spectrum,raw_signal,final_filter]=GetSignalSpectrumV2(spec,sxpa,slope,intercept);
...
for i=1:length(t0);
    ...
    u=max(filter);    
    ss(:,i)=ss(:,i)*me/u;
    final_filter=[final_filter,filter*me/u];
end;
raw_signal=z;
raw_spectrum=s;
final_spectrum=ss;
