function run_threshgrad_glm(unitFile, preprocFile, stimClass, trainingGroups, validationGroups, strfLength, transforms, threshold, outputFile, familyName, outputNL)
    ...
    %% set up output nonlinearity
    if ~exist('outputNL', 'var')
        switch family.type
            case 'gaussian'
