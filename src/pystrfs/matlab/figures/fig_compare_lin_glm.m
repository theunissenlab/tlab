function fig_compare_lin_glm(cellName, preprocType, stimClass)

    descs = {'DirectFit', 'DirectFit+NL', 'Threshgrad', ...
             'Lin+Poisson', 'Lin+Binomial', ...
             'GLM+Gaussian', 'GLM+Poisson', 'GLM+Binomial'};
    ...
    fnames = {'directfit.%s.%s.%d.h5', 'directfit.nl_dists.%s.%s.%d.h5', ...
              ...
              'threshgrad_glm.%s.%s.gaussian.0.50.%d.h5', ...
              'threshgrad_glm.%s.%s.poisson.0.50.%d.h5', ...
              'threshgrad_glm.%s.%s.binomial.0.50.%d.h5'};
