function varargout = finalcluster(varargin)
% FINALCLUSTER MATLAB code for finalcluster.fig
%      FINALCLUSTER, by itself, creates a new FINALCLUSTER or raises the existing
%      singleton*.
%
%      H = FINALCLUSTER returns the handle to a new FINALCLUSTER or the handle to
%      the existing singleton*.
%
%      FINALCLUSTER('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in FINALCLUSTER.M with the given input arguments.
%
%      FINALCLUSTER('Property','Value',...) creates a new FINALCLUSTER or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before finalcluster_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to finalcluster_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help finalcluster

% Last Modified by GUIDE v2.5 25-Apr-2012 15:41:53

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @finalcluster_OpeningFcn, ...
                   'gui_OutputFcn',  @finalcluster_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before finalcluster is made visible.
function finalcluster_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to finalcluster (see VARARGIN)
...
% Choose default command line output for finalcluster
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);
% keyboard
% UIWAIT makes finalcluster wait for user response (see UIRESUME)
...
function varargout = finalcluster_OutputFcn(hObject, eventdata, handles) 
