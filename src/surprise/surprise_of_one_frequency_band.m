function out = surprise_of_one_frequency_band(f_band,stims,stim_names,stim_familiarity,stim_used,w,d,b)
...
toc;
PC_Nbins = [15 4 4 4 4 6 6 6 6 15]; % How many bins to use for S and each kept PC.  The first entry is for S, and the next is for the *weakest* kept PC.
...
cond_p = surprise_get_10D_cond_p(joint_p);
clear joint_p;
toc;
disp('  ....  finding the probability of each stim')
tic;
out = surprise_cond_p_10D_to_output(cond_p,which_cubes,what_position,use_stim,lengths,stim_names);
toc;
