function out = surprise_of_one_frequency_band_7D(f_band,stims,stim_names,stim_familiarity,stim_used,w,d,b)
...
tic;
out = surprise_cond_p_7D_to_output(cond_p,which_cubes,what_position,use_stim,lengths,stim_names);
toc;
